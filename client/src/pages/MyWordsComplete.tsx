...
import { ChevronLeft, ChevronRight, X, Play, Pause, Shuffle, BarChart3, BookOpen, Type, List, Star } from 'lucide-react';
    ...
    return (
      <Card className="shadow-lg bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
        <CardContent className="p-8 text-center">
          <Icon className="h-16 w-16 mx-auto text-blue-300 mb-4" />
          <h3 className="text-xl font-semibold text-blue-800 mb-2">{emptyMessage}</h3>
                ...
                <div className="text-center space-y-2">
                  <div className="flex items-center justify-center gap-2">
                    <span className="text-lg font-semibold text-blue-800">
                      {Math.round(currentItem.assessmentResult.pronunciationScore)}%
                    </span>
                  </div>
...
export default function MyWordsComplete() {
