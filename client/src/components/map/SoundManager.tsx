...
export class SoundManager {
  ...
  initialize() {
    ...
    try {
      ...
      this.sounds = {
        hover: new Howl({
          src: ['/sounds/water-splash-small.mp3'],
          volume: 0.2,
          html5: true,
          onloaderror: () => {
        ...
        select: new Howl({
          ...
          onloaderror: () => {
            ...
            this.sounds.select = this.createSimpleTone(200, 0.2);
          }
        }),
        transition: new Howl({
          src: ['/sounds/wave-crash.mp3'],
          volume: 0.3,
          html5: true,
          onloaderror: () => {
            console.log("Fallback to simple beep for transition");
            this.sounds.transition = this.createSimpleTone(150, 0.3);
          }
        }),
        click: new Howl({
