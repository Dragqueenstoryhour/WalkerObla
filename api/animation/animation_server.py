...
# Path to Audio2Face-3D client script
A2F_CLIENT_SCRIPT = os.path.abspath("./Audio2Face-3D-Samples/scripts/audio2face_3d_api_client/nim_a2f_3d_client.py")
A2F_CONFIG_DIR = os.path.abspath("./Audio2Face-3D-Samples/scripts/audio2face_3d_api_client/config")
...
def generate_animation():
    ...
    try:
        ...
        try:
            ...
            # The Audio2Face client saves blendshapes.csv and emotions.csv in the current directory
            # We need to move them to our temp directory with the appropriate names
            try:
                if os.path.exists("blendshapes.csv"):
